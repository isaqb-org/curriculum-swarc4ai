...
[[LG-5-3]]
==== LG 5-3: Coordinate different quality features of an ML model
...
The participants know example tools for monitoring. This concerns both general tools, such as Prometheus & Grafana, as well as ML-specific tools, such as MLflow.
