...
The advanced level curriculum **{curriculum-name} [{curriculum-short}]** is currently maintained and published German (DE). Maintainers of this curriculum and voluntary reviewers collaborate on https://github.com/isaqb-org[GitHub] to improve the curriculum.
